...
const takeImage = document.getElementById('img_result');
...
function loadLabeledImages() {
    const labels = ['Andrii Kosaniak', 'Black Widow', 'Captain America', 'Captain Marvel', 'Hawkeye',  'Jim Carrey', 'Jim Rhodes', 'Johnny Depp', 'Thor', 'Tony Stark'];
    return Promise.all(
